    ...
    public function execute()
    {
        ...
        foreach ($collection as $location) {
            try {
                ...
                $this->_getSession()->addException($e, __('Something went wrong while updating status for %1.', $location->getName()));
            }
        }

        if ($locationUpdated) {
            $this->messageManager->addSuccessMessage(__('A total of %1 record(s) have been updated.', $locationUpdated));
        }
