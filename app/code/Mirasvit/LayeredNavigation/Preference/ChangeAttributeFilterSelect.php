...
// M 2.1 compatibility
if (class_exists('\Magento\CatalogSearch\Model\Search\FilterMapper\CustomAttributeFilter')) {
    abstract class ChangeAttributeFilterSelectAbstract extends \Magento\CatalogSearch\Model\Search\FilterMapper\CustomAttributeFilter {}
} else {
...
class ChangeAttributeFilterSelect extends ChangeAttributeFilterSelectAbstract
{
    ...
    public function apply(Select $select, FilterInterface ... $filters)
    {
        ...
        foreach ($filters as $filter) {
            $filterJoinAlias = $this->getAlias($filter);
