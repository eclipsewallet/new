...
class Config
{
    ...
    {
        # for prevent message issue
        /** @var \Mirasvit\Core\Helper\Cron $cronHelper */
        $cronHelper = ObjectManager::getInstance()
            ->create(\Mirasvit\Core\Helper\Cron::class);

        return $cronHelper->checkCronStatus(null)[0];
    }
